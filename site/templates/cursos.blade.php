...
<?php foreach($page->children()->listed()->flip() as $cursos): ?>
  ...
  <div class="p-10 xl:p-0">
	...
	<a href="<?= $cursos->url() ?>">
	<img class="absolute my-0 xl:my-6" style="margin-left: 102px;" src="/images/iso.png" alt="Isotipo" width="181" height="500">
	<img class="w-full" src="<?= $image->crop(420, 600)->url() ?>" class="m-auto">
	</a>
	<?php endif ?>
	<a href="<?= $cursos->url() ?>">
	<h1 class="text-2xl uppercase text-center my-6"><?= $cursos->titulo()->kti() ?></h1>
	</a>
  </div>
